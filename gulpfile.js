...
gulp.task('watch-less', ['bower'], function () {
    gulp.src('./src/assets/stylesheets/**/*.less').pipe(watch(function () {
        return gulp.src('./src/assets/stylesheets/humanLibrary.less').pipe(less()).pipe(gulp.dest('./src/assets/stylesheets')).pipe(connect.reload());
    }));
});
